        ...
        <div className="min-h-screen bg-gray-100 pb-12">
            ...
            <div className="flex items-center justify-between bg-white px-6 py-4 shadow-md sticky top-0 z-50">
                ...
                <button
                    ...
                    className="text-[1.1rem] md:text-[1.3rem] text-shadow-black transition md:hover:text-white cursor-pointer duration-300 px-4 py-2 md:bg-black border md:hover:bg-red-600 rounded-lg bg-black text-white md:text-white"
                >
                    Log In
                </button>
            </div>
            ...
            {/* CARD */}
            <div className="mx-auto mt-5 max-w-[320px] md:max-w-[600px] rounded-lg bg-white p-8 drop-shadow-2xl border-[2px] border-red-600/60">
