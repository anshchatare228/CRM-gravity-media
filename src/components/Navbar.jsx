    ...
    <>
      ...
      <div className="flex items-center justify-between bg-white/10 backdrop-blur-lg px-6 py-4 fixed top-0 left-0 right-0 z-30 transition-all border-b border-gray-200 md:hidden">
        ...
        <button
          ...
          className="p-2 rounded-lg text-black hover:bg-gray-550/10 active:scale-95 transition-all duration-200 focus:outline-none"
        >
      ...
      <div className={`
        ...
        <div className="pt-3 border-t border-gray-150/60 mt-auto">
          <button
            ...
            className="group flex w-full items-center gap-3.5 rounded-lg border border-gray-200 px-4 py-3.5 text-[0.95rem] font-medium text-gray-600 transition-all duration-200 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 active:scale-[0.98] cursor-pointer"
          >
