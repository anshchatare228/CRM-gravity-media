                    ...
                    <div className="rounded-lg bg-white border border-gray-200 shadow-[0px_0_10px_-3px_rgba(0,0,0,0.3)] p-6 mb-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className="text-xs font-semibold text-black/90 uppercase tracking-wide">Email</label>
                                    <input
                                        type="email"
                                        value={form.email}
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-black/90 uppercase tracking-wide">Phone</label>
                                    <input
                                        type="tel"
                                        value={form.phone}
